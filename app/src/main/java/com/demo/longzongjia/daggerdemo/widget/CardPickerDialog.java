package com.demo.longzongjia.daggerdemo.widget;
...
import com.demo.longzongjia.daggerdemo.di.component.DaggerFragmentComponent;
...
public class CardPickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DaggerFragmentComponent.builder()
                .appComponent(App.getApplication(getContext()).getAppComponent())
                .build()
                .inject(this);
